...
import type { PrayerSettings as _PrayerSettings, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrUpdateTasbihCounter(arg0: TasbihCounter): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateTasbihCounter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTasbihCounter(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteTasbihCounter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerPrayerSettings(): Promise<PrayerSettings | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerPrayerSettings();
    ...
    async getCallerTasbihCounters(): Promise<Array<TasbihCounter>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerTasbihCounters();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPrayerSettings(arg0: Principal): Promise<PrayerSettings | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrayerSettings(arg0);
                return from_candid_opt_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasbihCounters(arg0: Principal): Promise<Array<TasbihCounter>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasbihCounters(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async incrementTasbihCounter(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementTasbihCounter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetTasbihCounter(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetTasbihCounter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async savePrayerSettings(arg0: PrayerSettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.savePrayerSettings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PrayerSettings]): PrayerSettings | null {
